          ...
          <div class='trailContainer'>
            ...
            <div class='trailContainerWithoutMap'>
                  ...
                  <div class='rowsAndImageTrail'>
                    ...
                    <div class='imgTrail'>
                      <img src='".$row["imagine"]."' alt='traseu' id='imgTrail'>
                    </div>
                  </div>
          ...
          echo ($row["existaStartPeTraseu"] == 0                                        
            ...
            echo"
                    ...
                    <div class='twoButtons'>
                      <button type='button' class='button simpleButton'><a href='login.php'> Logare </a></button>
                      <button type='button' class='button simpleButton'><a href='register.php'> Inregistrare </a></button>
                    </div>
                ";
        }
